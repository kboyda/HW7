...
Partial Class Account_AddRole
    ...
    Public Sub BindRoles()
        ...
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("db_kboyda_HW7.1").ConnectionString
    ...
    Protected Sub list_allRoles_SelectedIndexChanged(sender As Object, e As EventArgs) Handles list_allRoles.SelectedIndexChanged
        ...
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("ddb_kboyda_HW7.1").ConnectionString
